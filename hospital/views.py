...
def doctor_prescription_view(request):
    ...
    return render(request,'hospital/doctor_prescription.html',context=mydict)

@login_required(login_url='doctorlogin')
@user_passes_test(is_doctor)
def doctor_add_prescrip_view(request,patient_id):
...
def patient_book_appointment_view(request):
    ...
    if request.method=='POST':
        ...
        if appointmentForm.is_valid():
            ...
            if doctor.department == 'Orthopedic':
                if 'knee' in desc:
                    pass
                else:
                    print('else')
            ...
            if doctor.department == 'Physiotherapist':
                if 'rehab' in desc:
                    pass
                else:
                    print('else')
